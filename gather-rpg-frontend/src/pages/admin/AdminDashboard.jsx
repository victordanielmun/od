...
export const AdminDashboard = () => {
    ...
    return (
        <div>
            ...
            <p className="text-gray-400 mb-8">Welcome to the Admin Control Center.</p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <StatCard title="Total Maps" value={stats.maps} icon={MapIcon} color="text-purple-500" />
                <StatCard title="Total Users" value="-" icon={Users} color="text-blue-500" />
                <StatCard title="Server Status" value="Online" icon={Server} color="text-green-500" />
            </div>
        </div>
    );
};
